...
async fn get_request_handler() -> impl IntoResponse {
    ...
    let response = ActionGetResponse {
        ...
        icon: "https://arweave.net/cDOLvbG08hhrIEt-p3ZKb-TVghr10--rR2ENm3FZLhQ".into(),
        description: "Donate SOL for this masterpiece".into(),
        links: Links {
            actions: vec![
                ActionLink {
...
async fn post_request_handler(
    ...
    let to_pubkey = Pubkey::from_str("7ui38FSR5budZ5ZUw6vK4Jhe1GosHYEXueKBFKtowzRh").unwrap();
